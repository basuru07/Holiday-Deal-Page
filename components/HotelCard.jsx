...
const AmenityIcon = ({ amenity }) => {
  const getIconForAmenity = (amenityName) => {
    ...
    if (lowerAmenity.includes("spa") || lowerAmenity.includes("massage"))
    ...
    if (lowerAmenity.includes("conditioning") || lowerAmenity.includes("air"))
      return <Zap size={16} />;
    ...
    <div className="bg-white rounded-lg overflow-hidden shadow-lg">
      ...
      <div className="p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              ...
              {hotel.amenities.length > 6 && (
                <div
                  ...
                  onClick={() =>
                    setSelectedModal({ type: "hotel", data: hotel })
                  }
                >
        ...
        <div>
          ...
          {Array.isArray(hotel?.roomAmenities) &&
