...
export default function ClientWrapper({ deal, setSelectedModal, sections }) {
  ...
  return (
    <>
      ...
      <HotelsSection hotels={deal.hotels} setSelectedModal={setSelectedModalState} />
      <DestinationsSection destinations={deal.destinations} setSelectedModal={setSelectedModalState} />
